...
enum DecalFontExtensionColor
{
    EXT_COLOR_FIRST = NUM_COLORS,

    EXT_COLOR_RED_BLUE_GRADIENT = EXT_COLOR_FIRST,
    EXT_COLOR_KING_GOLD,
    EXT_COLOR_GOLD_GRADIENT,
	EXT_COLOR_ADMIRAL_RED,
	EXT_COLOR_ALPHA_GRN,
	EXT_COLOR_BARON_TAN,
	EXT_COLOR_BASIL_RED,
	EXT_COLOR_KNIGHT_BLACK,
	EXT_COLOR_GAIL_GREEN,
	EXT_COLOR_JOHNNY_BROWN,
	EXT_COLOR_ISLANDER_ORANGE,
	EXT_COLOR_NOVA_GREY,
	EXT_COLOR_TURBO_GRN_RED,

    EXT_COLOR_END
};

#define NUM_EXTENSION_COLORS (EXT_COLOR_END - EXT_COLOR_FIRST)

extern u32 extensionColors[NUM_EXTENSION_COLORS][4];

CTR_STATIC_ASSERT(EXT_COLOR_END <= 0xfff);
